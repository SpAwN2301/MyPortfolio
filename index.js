...
const projectsArr   = [
    {
        name:           'Smart Orders',
        description:    'Сервис для быстрого оформления заказа в местах общепита и ресторанах.<br/>Всё, что нужно пользователю — это отсканировать QR код своего столика и выбрать предпочитаемые блюда из меню.<br/>Меню формируется на основе Гугл таблиц, что позволяет работникам легко и удобно управлять его содержимым.<br/>Оформленный заказ моментально попадает в базу данных и на экраны персонала, доступ к которому есть только у авторизованных работников заведения.'
    },
    {
